...
- **LLM-powered source intelligence** — upload regulation documents or add government source URLs; the active LLM plugin extracts structured compliance data and creates review proposals with trust levels (`certified` for W3C sources, `extracted` for LLM-parsed content)
