/**
 * LLM_TOOL_METADATA — per-tool RBAC annotations for the 5 LLM MCP tools.
 ...
 *
 * All 5 tools are GLOBAL (no org-scoped DB reads — inputs are supplied by
 ...
 *
 * All 5 tools are non-destructive read-path capability invocations.
 */
...
export const LLM_TOOL_METADATA: readonly ToolMetadata[] = [
  ...
  { name: 'llm_analyse_visual',       requiredPermission: 'llm.view' },
];
