...
export class MigrationRunner {
  ...
  async run(migrations: readonly Migration[]): Promise<void> {
    await this.pool.query(CREATE_SCHEMA_MIGRATIONS_SQL);
...
// ---------------------------------------------------------------------------
// Dashboard migrations (PostgreSQL-specific)
// ---------------------------------------------------------------------------
...
INSERT INTO roles (id, name, description, is_system, org_id, created_at) VALUES
  ('admin', 'admin', 'Full system administrator with all permissions', true, 'system', '2024-01-01T00:00:00.000Z'),
  ('developer', 'developer', 'Developer with technical access and fix capabilities', true, 'system', '2024-01-01T00:00:00.000Z'),
  ('user', 'user', 'Standard user with scanning and reporting access', true, 'system', '2024-01-01T00:00:00.000Z'),
  ('executive', 'executive', 'Executive with read-only access to reports and trends', true, 'system', '2024-01-01T00:00:00.000Z')
...
CREATE INDEX IF NOT EXISTS idx_audit_log_resource ON audit_log(resource_type, resource_id);
  ...
  },
  {
    ...
    sql: `
INSERT INTO role_permissions (role_id, permission) VALUES ('admin', 'audit.view')
ON CONFLICT (role_id, permission) DO NOTHING;
    `,
  },
  {
    ...
    sql: `
ALTER TABLE scan_records ADD COLUMN IF NOT EXISTS json_report TEXT;
    `,
  },
];
