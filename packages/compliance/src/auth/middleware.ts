...
// (see api/routes/mcp.ts) that verifies dashboard-issued JWKS-signed Bearer
// tokens with RFC 8707 audience enforcement. The service-global middleware
// here continues to validate local-signed tokens for /api/v1/* endpoints
// (tokens minted by /api/v1/oauth/token for internal bootstrap, D-10).
// The /.well-known/oauth-protected-resource endpoint is also public per RFC 9728.
const PUBLIC_PATHS = [
  '/api/v1/health',
  '/api/v1/openapi.json',
  '/api/v1/docs',
