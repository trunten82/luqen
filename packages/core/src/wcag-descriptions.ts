...
// Each entry provides a plain-language title, description, user impact statement, and official URL.
...
export const WCAG_DESCRIPTIONS: Record<string, WcagCriterionInfo> = {
  ...
  '1.2.4': {
    ...
    url: 'https://www.w3.org/WAI/WCAG21/Understanding/captions-live',
  },
  '1.2.5': {
