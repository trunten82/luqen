...
- [ ] **LLM-01**: Migration adds `llm_client_id` and `llm_client_secret` columns to the organizations table
- [ ] **LLM-02**: On new org creation, a per-org LLM OAuth client (`dashboard-{slug}`) is auto-created and stored
