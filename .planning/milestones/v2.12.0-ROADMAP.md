...
- [x] **Phase 26: Typography x-height Spike** - opentype.js viable; FontMetricsService + typography scorer 4th heuristic implemented (completed 2026-04-13)
- [x] **Phase 27: Historical Rescore** - Admin action: idempotent, resumable, skip-when-guideline-gone batch rescore of pre-v2.11.0 scans (completed 2026-04-14)
...
**Plans**: 2 plans
Plans:
- [x] 27-01-PLAN.md — Migration 046 + RescoreProgressRepository + RescoreService batch engine
- [x] 27-02-PLAN.md — Rescore routes + HTMX partials + confirmation dialog + polling + UAT
**UI hint**: yes
...
| 27. Historical Rescore | 2/2 | Complete   | 2026-04-14 |
