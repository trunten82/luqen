...
- [ ] **B. WordPress vision mirror — NOT STARTED** (separate PRIVATE repo; sanitizer blocker + enterprise badge + standalone screenshot capture; needs wp-test lxc + Playwright). Full edit-point plan in `.planning/NEXT-SESSION-PROMPT.md`.
